    ...
    <main className="min-h-screen bg-black">
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className={`container mx-auto px-4 relative z-10 transition-all duration-1000 transform ${
          ...
          <h1 className="text-6xl font-bold mb-6 gradient-text text-center float">
            Ontdek hier alle elektronische Top 10-lijsten die je nodig hebt!
          </h1>
          <p className="text-xl mb-8 text-center text-gray-300 shine">
              ...
              >
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform group-hover:translate-y-0 transition-transform duration-500">
                    <h2 className="text-3xl font-bold mb-2 gradient-text group-hover:scale-105 transition-transform duration-500">{category.title}</h2>
                    <p className="text-gray-300 text-lg transform group-hover:translate-x-2 transition-all duration-500">{category.description}</p>
                  </div>
                </div>
              </a>
            ))}
